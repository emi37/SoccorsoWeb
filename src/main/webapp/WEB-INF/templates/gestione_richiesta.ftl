...
<body class="flex-center-body">
    <main class="card-container-form">
        <header class="section-header text-left">
            <h2 class="section-title">Avvio missione #${richiesta.id_richiesta}</h2>
        </header>

        <section class="text-left mb-24">
            <p><b>Segnalante:</b> ${richiesta.nome_segnalante}</p>
        ...
        <section class="text-left">
            ...
            <form action="${request.contextPath}/GestioneRichiestaServletDallAdmin" method="POST">
                    ...
                    <div class="scrollable-list">
                        <#list operatori as operatore>
                            <div class="form-group-inline">
                                ...
                                <label for="op_${operatore.id_utente}">${operatore.nome} ${operatore.cognome} (${operatore.patenti} - ${operatore.abilita})</label>
                ...
                <fieldset class="fieldset-antispam">
                    ...
                    <div class="scrollable-list">
                        <#list mezzi as mezzo>
                            <div class="form-group-inline">
                                <input type="checkbox" id="mezzo_${mezzo.id_mezzo}" name="id_mezzo" value="${mezzo.id_mezzo}">
                                <label for="mezzo_${mezzo.id_mezzo}"><strong>${mezzo.nome}</strong> - ${mezzo.descrizione}</label>
                            </div>
                        <#else>
                ...
                <fieldset class="fieldset-antispam">
                    ...
                    <div class="scrollable-list">
                        <#list materiali as materiale>
                            <div class="form-group-inline">
                                <input type="checkbox" id="mat_${materiale.id_materiale}" name="id_materiale" value="${materiale.id_materiale}">
                                <label for="mat_${materiale.id_materiale}"><strong>${materiale.nome}</strong> - ${materiale.descrizione}</label>
                            </div>
                        <#else>
